...
export const TOPIK_EXTERNAL_RESOURCES: ExternalResourceItem[] = [
  // ── 102nd TOPIK (2025/2026) ────────────────────────────────────────────────
  {
    id: "topik-102-paper",
    provider: "TOPIK_GUIDE",
    providerName: "TOPIK GUIDE",
    title: "102nd TOPIK Previous Paper (Latest)",
    examNumber: 102,
    year: 2025,
    examType: "BOTH",
    format: "NEW_FORMAT",
    ...
    description: "Latest official 102nd TOPIK examination paper. Includes complete question booklets, listening audio files, transcript sheets, and verified answer keys for TOPIK I and TOPIK II.",
    recommendedFor: "Essential practice for the latest exam trends and newly introduced question styles.",
  },
  {
    id: "topik-102-mock-1",
    provider: "TOPIK_GUIDE",
    providerName: "TOPIK GUIDE",
    title: "102nd TOPIK I Online Mock Test",
    examNumber: 102,
    year: 2025,
    examType: "TOPIK_I",
    format: "NEW_FORMAT",
    ...
    timeLimitMins: 100,
    questionCount: 70,
    description: "Complete full-length interactive simulation of the 102nd TOPIK I exam. Features 30 Listening + 40 Reading questions with real-time countdown timer and instant score evaluation.",
    recommendedFor: "Beginner benchmark testing using the newest official TOPIK I paper.",
  },
  {
    id: "topik-102-mock-2",
    provider: "TOPIK_GUIDE",
    providerName: "TOPIK GUIDE",
    title: "102nd TOPIK II Online Mock Test",
    examNumber: 102,
    year: 2025,
    examType: "TOPIK_II",
    format: "NEW_FORMAT",
    ...
    timeLimitMins: 180,
    questionCount: 104,
    description: "Authentic timed simulation of the 102nd TOPIK II exam. Covers 50 Listening, 4 Writing tasks (51–54), and 50 Reading passages with section breakdown.",
    recommendedFor: "Intermediate & Advanced candidates testing pacing on the most recent official standard.",
  },
